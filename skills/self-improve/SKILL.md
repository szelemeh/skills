---
name: self-improve
description: Retrospective that turns this session's friction into small setup fixes. Use when the user wants to capture a correction, smooth out where you danced around a solution, or make the next session go better.
---

# Self-improve

Reflect on our interactions: where you stumbled, got a correction, danced around a
